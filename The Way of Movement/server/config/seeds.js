...
// section seeds
  ...
  console.log('sections seeded');
    ...
    await Post.create({
      ...
      // video: "URL",
      createdAt: new Date(),
      // sections: sections.slice(0, 3)[0]._id,    });
      sections: sections.slice(0, 3).map(section => section._id),
    });
    ...
    await Post.create({
      ...
      // video: "URL",
      createdAt: new Date(),
      sections: sections.slice(4, 6).map(section => section._id),
    });
    ...
    await Post.create({
      ...
      // video: "URL",
      createdAt: new Date(),
      // sections: sections.slice(7, 9)[0]._id,    
    });
    ...
    await Post.create({
      ...
      // video: "URL",
      createdAt: new Date(),
      // sections: sections.slice(10, 12)[0]._id,   
    });
    ...
    await Post.create({
      ...
      // video: "URL",
      createdAt: new Date(),
      // sections: sections.slice(13, 15)[0]._id,    
    });
